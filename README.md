...
The dark responsive shell provides routes for Overview, CPU, Memory, Filesystems, Docker, Events, Audit, and Backups. Routes other than Overview are honest placeholders until their roadmap tasks add data.
